...
import numpy as np
import hacked_attn
#import tensorflow.contrib.rnn as hacked_attn 
...
def BiRNN(x, weights, biases):
    ...
    gru_fw_cell = hacked_attn.AttentionCellWrapper(tf.nn.rnn_cell.GRUCell(n_hidden), 15)
    # Backward direction cell
    gru_bw_cell = hacked_attn.AttentionCellWrapper(tf.nn.rnn_cell.GRUCell(n_hidden), 15)
